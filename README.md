...
|---|---|
| **Name** | APEKSHA SINGH |
| **Registration Number** | 24BCE10798 |
...
```bash
https://github.com/Apekshacin/oss_audit_24BCE10798/edit/main/README.md
cd oss-audit-24BCE10798
```
...
```
================================================
    Open Source Audit - APEKSHA SINGH
    Reg: 24BCE10798 | VIT Bhopal University
================================================
...
Current User     : apeksha
Home Directory   : /home/APEKSHA
...
├── OSS_Capstone_24BCe10798.docx  # Full project report
└── README.md                   # This file
```
